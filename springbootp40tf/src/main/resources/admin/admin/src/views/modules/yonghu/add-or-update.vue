<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出生年月日" prop="chushengnianyueri">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chushengnianyueri" 
                type="date"
                placeholder="出生年月日">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chushengnianyueri" label="出生年月日" prop="chushengnianyueri">
              <el-input v-model="ruleForm.chushengnianyueri" 
                placeholder="出生年月日" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
